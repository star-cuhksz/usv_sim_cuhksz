...
fieldsVZ = []
fieldNames = []
pkg_path = "~/Documents/ProgramFiles/ROS/usv_simplified/src/usv_sim_cuhksz/usv_env_disturbs/wind_current/"
...
def loadMapVX(id, z):
    ...
    rospy.loginfo("################### Preparing map. Size (%d, %d) origin(%d, %d)",
...
if __name__ == '__main__':
    ...
    if (len(sys.argv) != 3):
        rospy.logerr(
            "###################Error: argument count invalid! %d", len(sys.argv))
