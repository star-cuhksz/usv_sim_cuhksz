...
/////////////////////////////////////////////////
void Foil_Dynamics_Plugin::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
...
/////////////////////////////////////////////////
void Foil_Dynamics_Plugin::Init()
{
...
void Foil_Dynamics_Plugin::OnUpdate()
{
...
/////////////////////////////////////////////////
void Foil_Dynamics_Plugin::OnUpdateRudder()
{
...
void Foil_Dynamics_Plugin::OnUpdateKeel()
{
...
void Foil_Dynamics_Plugin::OnUpdateSail()
{
...
void Foil_Dynamics_Plugin::ReadWaterCurrent(const geometry_msgs::Vector3::ConstPtr &_msg)
{
...
void Foil_Dynamics_Plugin::WaterThreadLoop()
{
	ros::Rate r(10);
	while (running)
	{
...
void Foil_Dynamics_Plugin::WindThreadLoop()
{
	ros::Rate r(10);
	while (running)
	{
